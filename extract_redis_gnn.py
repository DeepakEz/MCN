"""Extract GNN router experiment runs from Redis -> categorized_runs_gnn.jsonl"""
import redis
import json
import sys
...
out = "/results/categorized_runs_gnn.jsonl"
